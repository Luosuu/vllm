#!/bin/bash
# Offline batch profiling for nano-vllm with Qwen3-32B using all 4 Proton configurations.
#
# Runs nano-vllm's offline inference with Proton profiling in 4 configurations:
#   1. shadow+tree   2. shadow+trace   3. python+tree   4. python+trace
# Each config outputs to a separate subdirectory under profiling_output/nano_vllm/offline/.
#
# Usage: bash scripts/profiling/nano_vllm_offline.sh [OPTIONS]
...
OUTPUT_BASE="$REPO_ROOT/profiling_output/nano_vllm/offline"
...
echo "============================================"
echo "nano-vllm Offline Batch Profiling"
echo "============================================"
echo "Model:       $MODEL"
